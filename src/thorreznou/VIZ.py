...
def basic_scatterplot(dataframe,numeric_var1,numeric_var2,palette='tab10'):
    '''
    This function shows the graph scatterplot.
    ### Parameters(4):
        * dataframe: `dataframe`  origin table
        * numeric_var1:  `str` numeric variable
        * numeric_var2:  `str` numeric variable
        * palette:  `str` by default 'tab10', but you can choose your palette
    '''
    plt.figure(figsize=(13,7))
    sns.scatterplot(data=dataframe, x=numeric_var1, y=numeric_var2, palette=palette)
    titulo= numeric_var1.upper() + '_vs_' + numeric_var2.upper()
    plt.title(titulo, fontsize=15);
...
def ej_basic_scatterplot():
    ...
    print("SCATTER PLOT")
    basic_scatterplot(dataframe,"tip","total_bill")
...
def write_basic_scatterplot():
    ...
    '''
    print("You can use this function -> basic_scatterplot(dataframe,numeric_var1,numeric_var2,palette='tab10')")
...
def advance_scatterplot(dataframe,numeric_var1,numeric_var2,categ_var,palette='tab10'):
    '''
    This function shows the graph scatterplot.
    ### Parameters(5):
        * dataframe: `dataframe`  origin table
...
def ej_advance_scatterplot():
    ...
    dataframe = sns.load_dataset("tips")
    print("SCATTER PLOT")
    advance_scatterplot(dataframe,"tip","total_bill","sex")
...
def write_advance_scatterplot():
    ...
    This function shows the graph's code.
    '''
    print("You can use this function -> advance_scatterplot(dataframe,numeric_var1,numeric_var2,categ_var,palette='tab10')")
...
def basic_lineplot(dataframe,numeric_var1,numeric_var2,palette='tab10'):
    '''
...
def ej_basic_lineplot():
    ...
    print("LINE PLOT")
    basic_lineplot(dataframe,"year","passengers")
...
def write_basic_lineplot():
    ...
    This function shows the graph's code.
    '''
    print("You can use this function -> basic_lineplot(dataframe,numeric_var1,numeric_var2,palette='tab10')")
...
def advance_lineplot(dataframe,numeric_var1,numeric_var2,categ_var,palette='tab10'):
    '''
    This function shows the graph lineplot.
    ### Parameters(5):
        * dataframe: `dataframe`  origin table
...
def ej_advance_lineplot():
    ...
    dataframe = sns.load_dataset("flights")
    print("LINE PLOT")
    advance_lineplot(dataframe,"year","passengers","month")
...
def write_advance_lineplot():
    ...
    This function shows the graph's code.
    '''
    print("You can use this function -> advance_lineplot(dataframe,numeric_var1,numeric_var2,categ_var,palette='tab10')")
...
def basic_histplot(dataframe,numeric_var,palette='tab10'):
    '''
...
def ej_basic_histplot():
    ...
    print("HISTPLOT")
    basic_histplot(dataframe,"body_mass_g")
...
def write_basic_histplot():
    ...
    This function shows the graph's code.
    '''
    print("You can use this function -> basic_histplot(dataframe,numeric_var,palette='tab10')")
...
def advance_histplot(dataframe,numeric_var,categ_var,palette='tab10'):
    '''
    This function shows the graph histplot.
    ### Parameters(4):
        * dataframea: `dataframe`  origin table
...
def ej_advance_histplot():
    '''
    This function shows an example of the graph
    '''
    dataframe = sns.load_dataset("penguins")
    print("HISTPLOT")
    advance_histplot(dataframe,"body_mass_g","sex")


def write_advance_histplot():
    '''
    This function shows the graph's code.
    '''
    print("You can use this function -> advance_histplot(dataframe,numeric_var,categ_var,palette='tab10')")
...
def basic_barplot(dataframe,numeric_var,categ_var,palette='tab10'):
    '''
...
def ej_basic_barplot():
    ...
    print("BARPLOT")
    basic_barplot(dataframe,"class","fare")
...
def write_basic_barplot():
    ...
    This function shows the graph's code.
    '''
    print("You can use this function -> basic_barplot(dataframe,numeric_var,categ_var,palette='tab10')")
...
def advance_barplot(dataframe,numeric_var,categ_var1,categ_var2,palette='tab10'):
    '''
    This function shows the graph barplot.
    ### Parameters(5):
        * dataframe: `dataframe`  origin table
        * numeric_var:  `str` numeric variable
        * categ_var1: `str` categoric variable
        * categ_var2: `str` categoric variable
        * palette:  `str` by default 'tab10', but you can choose your palette
    '''
    plt.figure(figsize=(13,7))
    ...
    plt.legend(bbox_to_anchor=(1, 1), loc=2) ;
    titulo= numeric_var.upper() + '_vs_' + categ_var1.upper()
    plt.title(titulo, fontsize=15);
    plt.xlabel(numeric_var)
    plt.ylabel(categ_var1)
    plt.show()
...
def ej_advance_barplot():
    ...
    dataframe = sns.load_dataset("titanic")
    print("BARPLOT")
    advance_barplot(dataframe,"class","fare","sex")
...
def write_advance_barplot():
    ...
    This function shows the graph's code.
    '''
    print("You can use this function -> advance_barplot(dataframe,numeric_var,categ_var1,categ_var2,palette='tab10')")
...
def basic_density(dataframe,numeric_var,palette='tab10'):
    '''
...
def write_basic_density():
    ...
    This function shows the graph's code.
    '''
    print("You can use this function -> basic_density(dataframe,numeric_var,palette='tab10')")
...
def advance_density(dataframe,numeric_var,categ_var,palette='tab10'):
    '''
    This function shows the graph density.
    ### Parameters(4):
        * dataframe: `dataframe`  origin table
...
def ej_advance_density():
    ...
    dataframe = sns.load_dataset("titanic")
    print("DENSITY PLOT")
    advance_density(dataframe,"age", "sex")
...
def write_advance_density():
    ...
    This function shows the graph's code.
    '''
    print("You can use this function -> advance_density(dataframe,numeric_var,categ_var,palette='tab10')")
...
def basic_boxplot(dataframe,categ_var,numeric_var,palette='tab10'):
    '''
    ...
    titulo= categ_var.upper() + '_vs_' + numeric_var.upper()
    plt.title(titulo, fontsize=15);
...
def ej_basic_boxplot():
    ...
    dataframe = sns.load_dataset("tips")
    print("BOXPLOT")
    basic_boxplot(dataframe,"day","tip")
...
def write_basic_boxplot():
    ...
    This function shows the graph's code.
    '''
    print("You can use this function -> basic_boxplot(dataframe,categ_var,numeric_var,palette='tab10')")
...
def advance_boxplot(dataframe,categ_var1,numeric_var,categ_var2,palette='tab10'):
    '''
    This function shows the graph boxplot.
    ### Parameters(5):
        * dataframe: `dataframe`  origin table
    ...
    '''
    plt.figure(figsize=(13,7))
    sns.boxplot(data = dataframe, x = categ_var1, y = numeric_var,
                palette = palette, hue = categ_var2)
    plt.legend(bbox_to_anchor=(1, 1), loc=2) ;
    titulo=categ_var1.upper() + '_vs_' + numeric_var.upper() + '_vs_' + categ_var2.upper()
    plt.title(titulo, fontsize=15);
...
def ej_advance_boxplot():
    ...
    dataframe = sns.load_dataset("tips")
    print("BOXPLOT")
    advance_boxplot(dataframe,"time","tip","smoker")
...
def write_advance_boxplot():
    ...
    This function shows the graph's code.
    '''
    print("You can use this function -> advance_boxplot(dataframe,categ_var1,numeric_var,categ_var2,palette='tab10')")
...
def basic_violinplot(dataframe,categ_var,numeric_var,palette='tab10'):
    '''
...
def ej_basic_violinplot():
    ...
    dataframe = sns.load_dataset("tips")
    print("VIOLINPLOT")
    basic_violinplot(dataframe,"day","tip")
...
def write_basic_violinplot():
    ...
    This function shows the graph's code.
    '''
    print("You can use this function -> basic_violinplot(dataframe,categ_var,numeric_var,palette='tab10')")
...
def advance_violinplot(dataframe,categ_var1,numeric_var,categ_var2,palette='tab10'):
    '''
    This function shows the graph violinplot.
    ### Parameters(5):
        * dataframe: `dataframe`  origin table
    ...
    plt.legend(bbox_to_anchor=(1, 1), loc=2) ;
    titulo= categ_var1.upper() + '_vs_' + numeric_var.upper()
    plt.title(titulo, fontsize=15);
    plt.xlabel(categ_var1)
    plt.ylabel(numeric_var)
    plt.show()
...
def ej_advance_violinplot():
    ...
    dataframe = sns.load_dataset("tips")
    print("VIOLINPLOT")
    advance_violinplot(dataframe,"day","tip","smoker")
...
def write_advance_violinplot():
    ...
    This function shows the graph's code.
    '''
    print("You can use this function -> advance_violinplot(dataframe,categ_var1,numeric_var,categ_var2,palette='tab10')")
...
def basic_countplot(dataframe,categ_var,palette='tab10'):
    '''
...
def ej_basic_countplot():
    ...
    dataframe = sns.load_dataset("titanic")
    print("COUNTPLOT")
    basic_countplot(dataframe,"class")
...
def write_basic_countplot():
    ...
    This function shows the graph's code.
    '''
    print("You can use this function -> basic_countplot(dataframe,categ_var,palette='tab10')")
...
def advance_countplot(dataframe,categ_var1,categ_var2,palette='tab10'):
    '''
    This function shows the graph countplot.
    ### Parameters(4):
        * dataframe: `dataframe`  origin table
    ...
    plt.legend(bbox_to_anchor=(1, 1), loc=2) ;
    titulo=categ_var1.upper() + '_vs_' + categ_var2.upper()
    plt.title(titulo, fontsize=15);
    plt.xlabel(categ_var1)
    plt.ylabel(categ_var2)
    plt.show()
...
def ej_advance_countplot():
    ...
    '''
    dataframe = sns.load_dataset("titanic")
    advance_countplot(dataframe,"class","who")
...
def write_advance_countplot():
    ...
    This function shows the graph's code.
    '''
    print("You can use this function -> advance_countplot(dataframe,categ_var1,categ_var2,palette='tab10')")
...
def basic_pie(dataframe,categ_var):
    '''
...
def ej_basic_pie():
    ...
    dataframe = sns.load_dataset("titanic")
    print("PIE")
    basic_pie(dataframe,"sex")


def write_basic_pie():
    print("You can use this function -> basic_pie(dataframe,categ_var)")
    '''
    This function shows the graph's code.
    '''
...
def var_question():
    ...
    '''
    while True:
        var = input(str('For your graph do you wanna use 1, 2 or 3 variables (select 1, 2, 3)'))
        if var == "1":
            if var == "1":
                types = input(str('Which tipe of variable do you want to plot? 1):a numeric variable or 2: is a categorical variable (Please, select 1 or 2)')).lower()
                if types == "1":
                    types = "numeric"
                    return types
                elif types == "2":
            ...
            types = input(str('What do you want to cross? 1: a numeric variable with a category variable, 2: a numeric with another numeric, 3: a category with another categoric (Please answer 1 or 2 or 3')).lower()
            if types == "1":
...
def show_graph(types):
	...
	while True:
		if types == "categoric":
			...
			print("2")
			ej_basic_pie()
			graph = input('From this examples, which graph do you want to use? Choose a number').lower()
			return graph
...
def select_graph(types,graph):
    ...
    elif types == "numeric" and graph == "2":
        write_basic_density()
    ...
    elif types == "numeric_categoric" and graph == "4":
        write_advance_histplot()
    elif types == "numeric_categoric" and graph == "5":
